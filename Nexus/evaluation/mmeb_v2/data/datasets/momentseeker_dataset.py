...
LOCAL_MOMENTSEEKER_JSONL = {
    "MomentSeeker": "momentseeker.jsonl",
    "MomentSeeker_1k8": "momentseeker_1k8.jsonl",
}
...
def _resolve_local_jsonl_path(data_args, kwargs):
    ...
    filename = LOCAL_MOMENTSEEKER_JSONL.get(kwargs.get("dataset_name"))
