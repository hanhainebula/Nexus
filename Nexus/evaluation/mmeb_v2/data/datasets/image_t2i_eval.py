...
from ...utils.dataset_utils import load_hf_dataset
...
def data_prepare(batch_dict, *args, **kwargs):
    ...
    for qry_inst, qry_text, tgt_inst, tgt_captions, tgt_img_paths in zip(
        ...
        for i, tgt_img_path in enumerate(tgt_img_paths):
            ...
            cand_item = {
                "image": full_img_path,
                # Keep target-side inputs aligned with official MMEB/Qwen parsing:
                # image retrieval candidates should not receive tgt_inst as a system prompt.
            }
...
def load_image_t2i_dataset(model_args, data_args, *args, **kwargs):
    ...
    dataset = load_hf_dataset((DATASET_HF_PATH, dataset_name, "test"))
