...
from UniRetrieval.training.text_retrieval.abc.embedder import AbsEmbedderRunner, AbsEmbedderModel, EmbedderTrainerCallbackForDataRefresh
...
class EncoderOnlyEmbedderRunner(AbsEmbedderRunner):
    ...
    def load_model(self, *args, **kwargs):
        return self.load_tokenizer_and_model()[1]
