...
from UniRetrieval.evaluation.text_retrieval import (
    TextRetrievalEvalRunner, 
    TextRetrievalEvalDenseRetriever, TextRetrievalEvalReranker
)
...
class AIRBenchEvalRunner:
    ...
    def load_retriever_and_reranker(self) -> Tuple[TextRetrievalEvalDenseRetriever, Union[TextRetrievalEvalReranker, None]]:
        ...
        """
        embedder, reranker = TextRetrievalEvalRunner.get_models(self.model_args)
