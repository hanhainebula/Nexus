...
from UniRetrieval.training.embedder.recommendation.tde_modeling import TDEModel as RetrieverTDEModel
from UniRetrieval.training.reranker.recommendation.tde_modeling import TDEModel as RankerTDEModel
