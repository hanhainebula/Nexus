...
def main():
    ...
    eval_config_path = "/data1/home/recstudio/haoran/InfoNexus/examples/recommendation/eval/eval_config.json"
    model_config_path = "/data1/home/recstudio/haoran/InfoNexus/examples/recommendation/eval/eval_model_config.json"
