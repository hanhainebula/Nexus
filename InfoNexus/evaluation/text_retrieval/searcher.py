...
from InfoNexus.abc.inference import AbsEmbedder, AbsReranker
from InfoNexus import BaseEmbedderInferenceEngine, BaseRerankerInferenceEngine, TextEmbedder, TextReranker
from .utils import index, search

logger = logging.getLogger(__name__)


class TextRetrievalEvalRetriever(ABC):
    """
...
class TextRetrievalEvalDenseRetriever(TextRetrievalEvalRetriever):
    """
